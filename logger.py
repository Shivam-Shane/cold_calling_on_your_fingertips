import logging
import os
logger=logging.getLogger("COLD CALLING")               #using named loggers, we can control the logging level for different parts

LOG_FILE = "COLD_CALLING_EMAILS.log"                       # What type of log file name to use
